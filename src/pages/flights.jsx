                ...
                <div className="py-[30px] relative">
                    ...
                    <div className="mt-[50px]">
                        <div className="relative">
                            <img src={flights} alt="flights" className="w-full object-cover h-[500px] rounded-[25px] backdrop-brightness-50" />
                        ...
                        <div className="mt-[50px] flex flex-wrap gap-[25px]">
                            ...
                            <div className="relative w-fit">
                                <img src="https://i.insider.com/649b13386eb0a800194d589a?width=700" alt="pic" className="w-[310px] h-[420px] hover:scale-105 transition-all object-cover rounded-[15px]" />
